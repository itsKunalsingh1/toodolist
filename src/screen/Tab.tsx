  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        <TouchableOpacity style={styles.cusmatic}>
          <Text style={styles.cusmaticText}>Makeup</Text>
          <Image
            source={{
        ...
        <TouchableOpacity style={styles.cusmatic}>
          <Text style={styles.cusmaticText}>Bridal Makeup</Text>
          <Image
            source={{
        ...
        <TouchableOpacity style={styles.cusmatic}>
          <Text style={styles.cusmaticText}>Threading</Text>
          <Image
            source={{
              uri: 'https://cdn-icons-png.flaticon.com/128/12105/12105336.png',
            }}
            style={styles.bridalmakeup}
          />
